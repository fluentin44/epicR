...
raw_data <-         paste0(params$raw_results_file)
combat_data_raw <-  readRDS(paste0(params$combat_data_file)) 
pheno_data_raw <-   readRDS(paste0(params$pheno_data_file))         
corrplot <-         read.table(paste0(params$corr_plot_file), 
                               sep = "\t", 
                               header=T
                               )
